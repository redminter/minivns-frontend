...
export class TaskService {
  ...
  public updateTask(user_id:string|null,subject_id:string|null,task_id:number|undefined, task:Task):Observable<Subject>{
    return this.http.put<Subject>(`${this.apiServerUrl}/users/${user_id}/subjects/${subject_id}/tasks/${task_id}`, task);
  }
